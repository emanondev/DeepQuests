...
import emanondev.quests.interfaces.storage.ISection;
import emanondev.quests.interfaces.storage.ISpigotSection;
import emanondev.quests.interfaces.storage.SpigotSection;

public class YmlSection implements ISection {
	...
	public YmlSection(final Map<String, Object> values) {
		this();
			...
			if (value instanceof Map) {
				...
				for (Object object : list) {
					if (object instanceof Map) {
						sections.add(new YmlSection((Map<String, Object>) object));
					} else {
						sections.clear();
	...
	public void set(String path, Object value) {
		if (value instanceof Map) {
			value = new YmlSection((Map<String, Object>) value);
		}
	...
	public List<Integer> getIntegerList(String path) {
		...
		for (Object object : list) {
			...
			} else if (ConfigUtils.isInteger(object)) {
	...
	public List<Double> getDoubleList(String path) {
		...
		for (Object object : list) {
			...
			} else if (ConfigUtils.isDouble(object)) {
	...
	public List<Boolean> getBooleanList(String path) {
		...
		for (Object object : list) {
			...
			} else if (ConfigUtils.isBoolean(object)) {
	...
	public List<Long> getLongList(String path) {
		...
		for (Object object : list) {
			...
			} else if (ConfigUtils.isLong(object)) {
	...
	public List<Byte> getByteList(String path) {
		...
		for (Object object : list) {
			...
			} else if (ConfigUtils.isByte(object)) {
	...
	public List<Short> getShortList(String path) {
		...
		for (Object object : list) {
			...
			} else if (ConfigUtils.isShort(object)) {
	...
	public List<Float> getFloatList(String path) {
		...
		for (Object object : list) {
			...
			} else if (ConfigUtils.isFloat(object)) {
	...
	public List<BigInteger> getBigIntegerList(String path) {
		...
		for (Object object : list) {
			if (ConfigUtils.isBigInteger(object.toString())) {
	...
	public List<BigDecimal> getBigDecimalList(String path) {
		...
		for (Object object : list) {
			if (ConfigUtils.isBigDecimal(object.toString())) {
	...
	public ISection getSection(String path) {
		...
		return this.get(path, new YmlSection(new LinkedHashMap<>()));
	}

	@Override
	public ISection createSection(String key) {
		ISection section = new YmlSection(new LinkedHashMap<>());
	...
	private ISection getSectionFor(String path) {
		...
		if (index == -1) {
			...
			if (section == null) {
				section = new YmlSection(new LinkedHashMap<>());
				this.self.put(root, section);
			}

			return (YmlSection) section;
		}
	}
